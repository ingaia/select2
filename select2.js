...
(function ($, undefined) {
    ...
    AbstractSelect2 = clazz(Object, {
        ...
        positionDropdown: function() {
            ...
            var options = this.container.find('.select2-choices');
            ...
            if (above) {
                ...
                css.top = this.container.offset().top + options.height();
                css.bottom = 'auto';
    ...
    MultiSelect2 = clazz(AbstractSelect2, {
        ...
        updateSelection: function (data) {
            ...
            this.dropdown.css({
                top: this.container.offset().top + options.height()
            });
            ...
            if(enableChoice){
                choice.find(".select2-search-choice-close")
                    ...
                    .on("click dblclick", this.bind(function (e) {
                        ...
                        // Avoid closing select2-choices when clicking select2-search-choice-close
                        //this.close();
                        this.results.empty()
                        //==================
